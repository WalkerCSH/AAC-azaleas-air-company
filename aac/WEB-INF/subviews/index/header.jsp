...
<script type="text/javascript">
    ...
    function readyHandler() {
        $(".club_title").click(memberActionHandler);
    }
    var i = 0;
    function memberActionHandler() {
        if (i === 0) {
            $("#club_content").removeClass("display_none");
            i = 1;
        } else {
            $("#club_content").addClass("display_none");
            i = 0;
        }
    }
</script>
...
<%
    ...
    session.removeAttribute("seatsSelectedSet");
